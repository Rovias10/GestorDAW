...
exports.register = async (req, res) => {
  ...
  try {
    ...
    const verifyLink = `http://127.0.0.1:5500/frontend-sin-simular/pages/auth/verify.html?token=${verificationToken}`;
...
exports.forgotPassword = async (req, res) => {
  ...
  try {
    ...
    const resetUrl = `http://127.0.0.1:5500/frontend-sin-simular/pages/auth/reset-password.html?token=${token}`;
    await sendEmail(
      email,
