...
exports.register = async (req, res) => {
  ...
  try {
    ...
    const verifyLink = `https://gestordaw.ddns.net/pages/auth/verify.html?token=${verificationToken}`;
...
exports.forgotPassword = async (req, res) => {
  ...
  try {
    ...
    const resetUrl = `https://gestordaw.ddns.net/pages/auth/reset-password.html?token=${token}`;
    await sendEmail(
      email,
